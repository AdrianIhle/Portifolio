...
AudioSource* SoundManager::createSource(GameObject* owner, std::string name, Vec3 pos, std::string filePath, bool loop, float gain)
{
    AudioSource* tempPtr = new AudioSource(owner, name, loop, gain);
...
void SoundManager::updateListener(Vec3 pos, Vec3 vel, Vec3 dir, Vec3 up)
{
    ALfloat posVec[3];
    ALfloat velVec[3];
    ALfloat headVec[6];
