...
void GameWidget::setWallsAndFloor()
{
    m_gulv->setVertex(0,-3,-2,2);
    m_gulv->setVertex(1,3,-2,-3);
    m_gulv->setVertex(2,-3,-2,-3);
    m_gulv->setVertex(3,3,-2,2);
    m_gulv->setVertex(4,3,-2,-3);
    m_gulv->setVertex(5,-3,-2,2);
